...
func (playerList *AvailablePlayersList) FindPlayer(p Player) (i int) {
	...
	// TODO:  REMOVE: FindPlayer is useless if availablePlayersList is a map.
...
func (playerList *AvailablePlayersList) GroupFourPlayers(groups *Groups) (Group, error) {
	if len(*playerList) >= 3 {
		...
		// TODO:  Implement an asynchronous function to verify if ID already exists and change it if its the case.
